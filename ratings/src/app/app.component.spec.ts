...
export class RatingListComponent {
  @Input() ratings: Rating[] = [
    ...
    },
    {
      ...
      content: 'ullam et saepe reiciendis voluptatem adipiscisit amet autem assumenda provident rerum culpa quis hic commodi nesciunt rem tenetur doloremque ipsam iure quis sunt voluptatem rerum illo velit',
      rate: 3.4,
    },
  ];
}
